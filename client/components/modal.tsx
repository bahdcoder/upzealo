...
export function Modal({ isOpen, setIsOpen, children, title, hideHeading, positionClasses, size = 'xlarge' }: PropsWithChildren<{
    isOpen?: boolean
    title?: string
    ...
    return (
        <Transition appear show={isOpen} as={Fragment}>
            <Dialog as="div" className="relative z-10" onClose={() => setIsOpen?.(false)}>
                ...
                <div className={classNames(positionClasses ? positionClasses : 'fixed inset-0 overflow-y-auto')}>
                    <div className="flex min-h-full items-center justify-center lg:p-4 text-center">
                        ...
                        >
                            <Dialog.Panel className={classNames('w-full h-screen lg:h-auto transform overflow-hidden lg:rounded-3xl bg-black p-6 text-left align-middle shadow-xl transition-all relative', {
