        ...
        <div className="w-full bg-black rounded-3xl p-6">
                ...
                <button>
                    <svg width={24} height={24} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g opacity="0.5" clipPath="url(#clip0_1_141)">
                            <path d="M2.16667 10.1667C3.36328 10.1667 4.33333 9.19661 4.33333 7.99999C4.33333 6.80338 3.36328 5.83333 2.16667 5.83333C0.97005 5.83333 0 6.80338 0 7.99999C0 9.19661 0.97005 10.1667 2.16667 10.1667Z" fill="#9CB6C5" />
                            <path d="M7.99999 10.1667C9.19661 10.1667 10.1667 9.19661 10.1667 7.99999C10.1667 6.80338 9.19661 5.83333 7.99999 5.83333C6.80338 5.83333 5.83333 6.80338 5.83333 7.99999C5.83333 9.19661 6.80338 10.1667 7.99999 10.1667Z" fill="#9CB6C5" />
                            <path d="M13.8333 10.1667C15.03 10.1667 16 9.19661 16 7.99999C16 6.80338 15.03 5.83333 13.8333 5.83333C12.6367 5.83333 11.6667 6.80338 11.6667 7.99999C11.6667 9.19661 12.6367 10.1667 13.8333 10.1667Z" fill="#9CB6C5" />
                        </g>
                        <defs>
            ...
            <div className="pl-16">
                <div className="mt-2 text-white">
                    ...
                    {image ? <div className="w-full mt-4">
                        <img src="https://scontent-los2-1.xx.fbcdn.net/v/t39.30808-6/297358499_4978326928938901_5330389093075701625_n.jpg?_nc_cat=109&ccb=1-7&_nc_sid=730e14&_nc_eui2=AeEX8f0v93cpfGk8P0KN_EQhjr5XCHHCSAaOvlcIccJIBhh7UHfa-33I4FVE-rKLmCH34cpC1MDE0eHzFHur8_u0&_nc_ohc=Kmh4Xysm0dgAX_C3rh3&_nc_zt=23&_nc_ht=scontent-los2-1.xx&oh=00_AT-wlUDzQrCejOUKcc9Q4D_bSP8bUKuYWS2jaOlXvEkuhw&oe=62F2D829" alt="post cover" className="rounded-lg w-full" />
                    </div> : null}
                </div>
                    ...
                    <div className="">
                        ...
                        <div className="w-full">
                            ...
                            <div className="pl-12 mt-2">
                                ...
                                <div className="mt-2">
                                    <button className='text-dark-300 hover:text-white transition ease-linear text-xs'>Like</button>
                                    <button className='text-dark-300 hover:text-white transition ease-linear ml-4 text-xs'>Reply</button>
                        ...
                        <div className="mt-4 flex items-center w-full">
                            <Avatar size='small' url='https://pbs.twimg.com/profile_images/1537681214546616320/xC9xGPn3_400x400.jpg' />
