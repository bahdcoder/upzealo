...
export function FollowRecommendations() {
  ...
  const { isLoading: isFetchingRecommendations, data: profiles = [] } = useQuery<UserProfile[]>(['follows'], async () => {
  ...
  return (
    <div className="flex flex-col mt-6 mb-6">
      ...
      {isFetchingRecommendations ? (
        ...
        <div className="mt-6 grid grid-cols-1 gap-y-6 h-96 overflow-y-auto">
